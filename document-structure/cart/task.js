const controler = Array.from(document.getElementsByClassName("product__quantity-control"));
...
let addButtn = Array.from(document.getElementsByClassName("product__add"));

addButtn.forEach(element => {    
    element.addEventListener("click", (event) => {
